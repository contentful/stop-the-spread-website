  ...
  <>
    ...
    <main className="py-4 lg:py-20 px-4 lg:px-0 lg:w-1/2 mx-auto">
      <section className="py-10">
        <h2 className="text-2xl lg:text-4xl font-semibold mb-4 text-gray-800 tracking-wide">Why is the JAMstack a good solution for such an announcement page?</h2>
      ...
      <section className="py-10">
        <h2 className="text-2xl lg:text-4xl font-semibold mb-4 text-gray-800 tracking-wide">Can I customize this to my needs?</h2>
      ...
      <section className="py-10">
        <h2 className="text-2xl lg:text-4xl font-semibold mb-4 text-gray-800 tracking-wide">Can I use this without any development resources?</h2>
      ...
      <section className="py-10">
        <h2 className="text-2xl lg:text-4xl font-semibold mb-4 text-gray-800 tracking-wide">Request an upgrade to a larger pro-bono account</h2>
        <p className="py-4 text-lg text-gray-800">If your Stop the Spread site outgrows the limits of the Micro space,
        email <MailToSupport /> with the subject line “stop the spread space limit," a link to your site and your organization name and ID.</p>
      ...
      <section className="py-10">
        <h2 className="text-2xl lg:text-4xl font-semibold mb-4 text-gray-800 tracking-wide">Can I also upgrade my Netlify account?</h2>
        <p className="py-4 text-lg text-gray-800">Yes. Netlify will also upgrade your account if requested. You can do so by …  (TBD)</p>
      </section>

      <section className="py-10">
        <h2 className="text-2xl lg:text-4xl font-semibold mb-4 text-gray-800 tracking-wide">I like this project. How can I help?</h2>
      ...
      <section className="py-10">
        <h2 className="text-2xl lg:text-4xl font-semibold mb-4 text-gray-800 tracking-wide">Where can I report issues or submit feature requests?</h2>
